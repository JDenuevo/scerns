...
$respondent_name = "Caloocan District";
// Fetch data based on the selected tab
$sql = "SELECT r.id, r.address, s.respondent_name, r.date
        FROM $reportTable r
        JOIN $statusTable s ON r.id = s.id
        WHERE r.type_of_emergency = '$tab' and s.respondent_name= '$respondent_name' and r.status = 'Done'";
