...
<body>
  ...
  <div class="text-center home-cont">
    ...
    <br>
    <i class="fa-solid fa-building-shield fa-2xl"></i>
    <h2>POLICE</h2>
  </div>
  ...
  <div class="container text-center">
    ...
    <div class="d-flex justify-content-between align-items-center mb-5">
      ...
      <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#guide-modal">
       <i class="fa-regular fa-circle-question text-light"></i> More info for Crime Alert Level
      </button>
    ...
    <div class="container text-center">
      <form action="report-qry.php" method="post">
        ...
        <input type="hidden" name="type_of_emergency" value="Police">
        ...
        <div class="form-floating">
          <select class="form-select" id="floatingSelect" name="levels" aria-label="" required>
            ...
            <option value="1">Level 1 (Robbery, Holdup, Snatching)</option>
            <option value="2">Level 2 (Harrasment, Violence)</option>
            <option value="3">Level 3 (Shooting)</option>
          </select>
          <label for="floatingSelect">Choose a crime level</label>
        </div>
    ...
    <div class="modal-content">
      <div class="modal-body">
        ...
        <div class="card border border-success rounded mb-3">
          <div class="card-body">
            <label><i class="fa-solid fa-circle mb-3 text-success"></i><span> (Low) </span>Crime Alert Level 1</label>
            <p>Condition: Low risk of criminal activity.</p>
            <p>Instructions: Standard law enforcement operations. Maintain awareness of surroundings.</p>
          </div>
        </div>

        <div class="card border border-warning rounded mb-3">
          <div class="card-body">
            <label><i class="fa-solid fa-circle mb-3 text-warning"></i><span> (Elevated) </span>Crime Alert Level 2</label>
            <p>Condition: Moderate risk, heightened potential for criminal incidents.</p>
            <p>Instructions: Increase security protocols, communicate with law enforcement, and stay informed through official channels.</p>
          </div>
        </div>

        <div class="card border border-danger rounded">
          <div class="card-body">
            <label><i class="fa-solid fa-circle mb-3 text-danger"></i><span> (Severe) </span>Crime Alert Level 3</label>
            <p>Condition: Critical risk, active criminal incidents occurring.</p>
            <p>Instructions: Activate emergency response procedures, follow law enforcement directives, and prioritize safety and security measures.</p>
          </div>
        </div>
