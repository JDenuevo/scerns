...
<head>
  ...
  <title>SCERNS | Notification</title>
    ...
    <div class="row g-2">
      <div class="col-12">
        <div class="card bg-primary rounded-3 shadow">
          <div class="card-body">
            <div class="d-flex">
              <img src="../assets/img/orig-logo.png" class="img-fluid" width="40px">
              <h5 class="fw-bold my-auto ms-3">Car Accident</h5>
              <div class="flex-grow-1"></div>
              <button class="btn btn-dark"><i class="fa-regular fa-thumbs-up"></i> Copy</button>
            </div>
            <div class="text-start my-3">
              <h6 class="fw-semibold">Location : <span class="fw-normal">Brgy.123 South Caloocan City</span></h6>
            </div>
            <div class="text-start my-3">
              <h6 class="fw-semibold">Involved : <span class="fw-normal">1 Motor Cycle & Van</span></h6>
            </div>
            <div class="text-start my-3">
              <h6 class="fw-semibold">Time : <span class="fw-normal">10:00:00 PM</span></h6>
            </div>
          </div>
        </div>
      </div>
